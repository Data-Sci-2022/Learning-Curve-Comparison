...
how to calculate lexical diversity: how many different words are used in each person's essay?; the number of word type divided by the number of tokens
